...
var app, text, dialogue, response, start, stop,apiAiTts;
...
SERVER_PORT = '4435';
ACCESS_TOKEN = '435dd24d78ef42c1bb96f2353023d743';
...
function App() {
    ...
    function _init() {
        ...
        apiAi.onResults = function (data) {
            ...
            phSearchInput.innerHTML = '';// clean input
			doExecute(data.result.action,data.result.parameters,data.result.actionIncomplete);
        };
